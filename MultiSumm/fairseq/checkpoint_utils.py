...
def load_teacher_checkpoint(args, trainer):
    """
    Load a teacher model's checkpoint.

    """
    teacher_checkpoint_path = os.path.join(args.save_dir, "checkpoint_last.pt")

    trainer.load_teacher_checkpoint(
