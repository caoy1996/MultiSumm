...
def add_checkpoint_args(parser):
    ...
    group.add_argument('--load-teacher-file', action='store_true',
                       help='if set, load the teacher model to conduct distillation')
    ...
    temperature_choices = ['linear_decay', 'exponential_decay', 'inverse_sigmoid_decay']
    group.add_argument('--temperatrue-scheduling', default=None, required=False,
                       choices=temperature_choices,
                       help='temperature scheduling function')
    group.add_argument('--tmax', default=1000., required=False, type=float,
                       help='maximal temperature')
    group.add_argument('--slope', default=5., required=False, type=float,
                       help='slope (c) in linear decay')
    group.add_argument('--v', default=0.98, required=False, type=float,
                       help='decay speed (v) in exponential decay')
    group.add_argument('--epsilon', default=35., required=False, type=float,
                       help='decay speed (e) in inverse sigmoid decay')
    # fmt: on
    return group
