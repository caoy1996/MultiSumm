...
class TrainerWithSKD(object):
    ...
    def load_teacher_checkpoint(self, teacher_checkpoint_path):
    ...
    def train_step(self, samples, dummy_batch=False, raise_oom=False, epoch=0, temperature=1.0):
        ...
        for i, sample in enumerate(samples):
            ...
            try:
                with maybe_no_sync():
                    ...
                    teacher_model = self.teacher_model if epoch > 1 else None
                    loss, sample_size, logging_output = self.task.train_step(
                        sample, self.model, self.criterion, self.optimizer,
                        ignore_grad, teacher_model=teacher_model, temperature=temperature
                    )
